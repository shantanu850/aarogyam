...
class DoctorViewTestSample extends StatefulWidget {
  final snapshot;
  final patentSnapshot;
  const DoctorViewTestSample({Key key, this.snapshot, this.patentSnapshot}) : super(key: key);
  @override
  _ViewTestSampleState createState() => _ViewTestSampleState();
}

class _ViewTestSampleState extends State<DoctorViewTestSample> {
