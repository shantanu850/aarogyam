...
class InvoiceViewPatient extends StatefulWidget {
  final snapshot1;
  final snapshot2;
  final data;
  final bool goBackHome;
  const InvoiceViewPatient({Key key, this.snapshot1, this.snapshot2, this.data,this.goBackHome = true}) : super(key: key);@override
  _InvoiceState createState() => _InvoiceState();
}

class _InvoiceState extends State<InvoiceViewPatient> {
  Future<bool> pop()async{
    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>PatentHome()));
              ...
              child:pw.ListView(
                children: [
                  ...
                  pw.Container(
                      ...
                      width: 100,
                      alignment: pw.Alignment.center,
                      child: (image!=null)?pw.Image(PdfImage.file(pdf.document,bytes:image)):pw.Text("QR Not Available",style: pw.TextStyle(fontWeight: pw.FontWeight.normal),)
                  ),
