...
class PatientViewDoctor extends StatefulWidget {
  final snapshot;

  const PatientViewDoctor({Key key, this.snapshot}) : super(key: key);
  @override
  _ViewDoctorState createState() => _ViewDoctorState();
}
class _ViewDoctorState extends State<PatientViewDoctor> {
  @override
