...
class UpdateOrder extends StatefulWidget {
  ...
  final medSum;
  final mList;
  const UpdateOrder({Key key, this.snapshot, this.medSum, this.mList}) : super(key: key);
  @override
...
class _PatRegState extends State<UpdateOrder> {
  ...
  void initState() {
    ...
    alt_mobCont.text = widget.snapshot['AlternatePhone'].toString();
    distCont.text = widget.snapshot['District'].toString();
    hnoCont.text = widget.snapshot['HouseNumber'].toString();
    landCont.text = widget.snapshot['Landmark'].toString();
    adding = false;
    super.initState();
  }
