...
class UpdateMedicine extends StatefulWidget {
  @required final data;
  const UpdateMedicine({Key key, this.data}) : super(key: key);
  @override
  _CreateMedicineState createState() => _CreateMedicineState();
}

class _CreateMedicineState extends State<UpdateMedicine> {
      ...
      bottomNavigationBar: (!submitting)?GestureDetector(
        onTap: ()async{
          ...
          if(_formKey.currentState.validate()) {
            http.post("http://www.notoutindia.com/aarogyam/api/UpdateMedicine",
                headers: {
                  "Authorization":prefs.getString('token'),
