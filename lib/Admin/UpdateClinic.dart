...
class UpdateClinic extends StatefulWidget {
  @required final snapshot;
  @required final index;
  const UpdateClinic({Key key, this.snapshot,this.index}) : super(key: key);
  @override
  _CreateMedicineState createState() => _CreateMedicineState();
}

class _CreateMedicineState extends State<UpdateClinic> {
  ...
  @override
  void initState() {
    nameController.text = widget.snapshot['Clinics'][widget.index]['ClinicName'];
    labRateController.text = widget.snapshot['Clinics'][widget.index]['ClinicAddress'];
